...
ActiveRecord::Schema[7.0].define(version: 2024_08_16_185015) do
  ...
  create_table "matchdays", force: :cascade do |t|
    t.datetime "lock_time", precision: nil
  ...
  create_table "scores", force: :cascade do |t|
    ...
    t.decimal "points", precision: 4, scale: 1, default: "0.0", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "season", default: "0000", null: false
    t.index ["matchday_id", "team_id", "season"], name: "score_key", unique: true
